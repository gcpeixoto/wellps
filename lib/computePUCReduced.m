function [PUC,nclasses,delta,divs] = computePUCReduced(J,active,method)
...
%           connections assuming a modified grid.
%
% KNOWLEDGE BASE
%           
% # Update 2023.4: 
...
%   ------------
%   
%   This method was adapted for reduced grids created after calling
%   MRST::co2lab::topSurfaceGrid.m, which remove cells from an 
%   already processed grid by processGRDECL. See ex7.m
%   
%
%   Regarding J
%   -----------
...
PUC = maskPUC(J,nclasses,divs,active);
...
function PUC = maskPUC(J,nclasses,divs,active)
...
% update required to trash all cells coming from
% "forced" modified ACTNUM 
jout(~active) = 0; 
