...
KN2 = KX.^2 + KY.^2 + KZ.^2;                     % normalized "maximal" (test)
...
RQIN2 = r(KN2);  RQIN2(isinf(RQIN2)) = 0; % normalized "maximal" (test)
...
FZIN2 = r(RQIN2); FZIN2(isnan(FZIN2)) = 0; % normalized "maximal" (test)
...
DRTN2_LN = r(FZIN2); DRTN2_LN(isinf(DRTN2_LN)) = 0; % normalized "maximal" (test)
...
DRTN2Star_LN = r(FZIN2Star); DRTN2Star_LN(isinf(DRTN2Star_LN)) = 0; % normalized "maximal" (test)
...
DRTN2_LOG10 = r(FZIN2); DRTN2_LOG10(isinf(DRTN2_LOG10)) = 0; % normalized "maximal" (test)
...
DRTN2Star_LOG10 = r(FZIN2Star); DRTN2Star_LOG10(isinf(DRTN2Star_LOG10)) = 0; % normalized "maximal" (test)
...
Log10RQIN2 = log10(RQIN2);  Log10RQIN2(isinf(Log10RQIN2)) = 0;   
...
LNRQIN2 = log(RQIN2);  LNRQIN2(isinf(LNRQIN2)) = 0;  % harmonic
...
Log10FZIStarN2_SQRTK = log10(0.0314*sqrt(KN2)); % hamonic
...
Log10FZIStarN2_SQRTK(isinf(Log10FZIStarN2_SQRTK)) = 0;
...
LNFZIStarN2_SQRTK = log(0.0314*sqrt(KN2)); % hamonic
...
LNFZIStarN2_SQRTK(isinf(LNFZIStarN2_SQRTK)) = 0;


% all params
p = {PHI, KX, KY, KZ,  PHIZ, KA, KG, KN, KQ, KH, KN2,                        ...
     RQIA, RQIG, RQIN, RQIQ, RQIH, RQIN2,                                    ...
     FZIA, FZIG, FZIN, FZIQ, FZIH, FZIN2,                                    ...
     FZIAStar, FZIGStar, FZINStar, FZIQStar, FZIHStar, FZIN2Star,            ...
     DRTA_LN, DRTG_LN, DRTN_LN, DRTQ_LN, DRTH_LN, DRTN2_LN                   ...
     DRTA_LOG10, DRTG_LOG10, DRTN_LOG10, DRTQ_LOG10, DRTH_LOG10, DRTN2_LOG10 ...
     DRTAStar_LN,                                                           ...
     DRTGStar_LN,                                                           ...
     DRTNStar_LN,                                                           ...
     DRTQStar_LN,                                                           ...
...
% field names
s = {'PHI', 'KX', 'KY', 'KZ', 'PHIZ', 'KA', 'KG', 'KN', 'KQ', 'KH', 'KN2',   ...
     'RQIA', 'RQIG', 'RQIN', 'RQIQ', 'RQIH','RQIN2',                         ...
     'FZIA', 'FZIG', 'FZIN', 'FZIQ', 'FZIH','FZIN2',                         ...
     'FZIAStar', 'FZIGStar', 'FZINStar', 'FZIQStar', 'FZIHStar','FZIN2Star', ...
     'DRTA_LN', 'DRTG_LN', 'DRTN_LN', 'DRTQ_LN', 'DRTH_LN', 'DRTN2_LN',      ...
     ...
     'Log10RQIH',                                                           ...    
     'Log10RQIN2',                                                           ...    
     'LNPHIZ', 'LNRQIA', 'LNRQIG', 'LNRQIN', 'LNRQIQ', 'LNRQIH','LNRQIN2',   ...
     'Log10FZIStarA_SQRTK',                                           ...
     'Log10FZIStarG_SQRTK',                                           ...
     'Log10FZIStarN_SQRTK',                                           ...
     'Log10FZIStarQ_SQRTK',                                           ...
